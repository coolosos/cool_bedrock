# Contributing to cool_bedrock

First of all, thank you for considering contributing to `cool_bedrock`! We appreciate all the help we can get to make this project better.
...
To get started with the development of `cool_bedrock`, you will need to have the Dart SDK installed on your machine.
...
7.  Open a pull request from your fork to the main `cool_bedrock` repository.
